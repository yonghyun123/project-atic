...
<body>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="testimonial-content">
                                        ...
                                        <p>âAlazea is a pleasure to work with. Their ideas are creative, they came up with imaginative solutions to some tricky issues, their landscaping and planting contacts are equally excellent we have a beautiful but also manageable garden as a result. Thank you!â</p>
    ...
    <section class="cool-facts-area bg-img section-padding-100-0" style="background-image: url(/resources/img/bg-img/cool-facts.png);">
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="single-cool-fact d-flex align-items-center justify-content-center mb-100">
                        <div class="cf-icon">
                            <img src="/resources/img/core-img/cf1.png" alt="">
                        </div>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="single-cool-fact d-flex align-items-center justify-content-center mb-100">
                        <div class="cf-icon">
                            <img src="/resources/img/core-img/cf2.png" alt="">
                        </div>
                        <div class="cf-content">
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="single-cool-fact d-flex align-items-center justify-content-center mb-100">
                        <div class="cf-icon">
                            <img src="/resources/img/core-img/cf4.png" alt="">
                        </div>
                        <div class="cf-content">
        ...
        <div class="side-img wow fadeInUp" data-wow-delay="500ms">
            <img src="/resources/img/core-img/pot.png" alt="">
        </div>
    </section>
    <!-- ##### Cool Facts Area End ##### -->
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-team-member text-center mb-100">
                        <!-- Team Member Thumb -->
                        <div class="team-member-thumb">
                            <img src="/resources/img/bg-img/team4.png" alt="">
                            <!-- Social Info -->
                            <div class="team-member-social-info">
                                <a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
