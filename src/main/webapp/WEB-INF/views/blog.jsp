          ...
          <div class="row">
              ...
              <div class="single-blog-post mb-50">
                ...
                <div class="post-content">
                  <a href="/single-post" class="post-title">
                    <h5>Garden designers across the country
                      forecast ideas shaping the gardening world in 2018</h5>
                  </a>
                  <div class="post-meta">
                  ...
                  <p class="post-excerpt">Integer luctus diam ac
                    scerisque consectetur. Vimus ottawas nec lacus sit
                    amet. Aenean interdus mid vitae.</p>
                </div>
              </div>
            </div>
            ...
            <div class="col-12 col-lg-6">
              <div class="single-blog-post mb-50">
                ...
                <div class="post-content">
                  <a href="/single-post" class="post-title">
                    <h5>The summer coming up, itâs time for both
                      us and the flowers to soak up the sunshine</h5>
                  </a>
                  <div class="post-meta">
                    <a href="#"><i class="fa fa-clock-o"
          ...
          <div class="post-sidebar-area">
            ...
            <div class="single-widget-area">
              ...
              <div class="single-latest-post d-flex align-items-center">
                ...
                <div class="post-content">
                  <a href="#" class="post-title">
                    <h6>The designers will create a new kitchen
                      garden</h6>
                  </a> <a href="#" class="post-date">20 Jun 2018</a>
                </div>
              </div>
              ...
              <div class="single-latest-post d-flex align-items-center">
                ...
                <div class="post-content">
                  <a href="#" class="post-title">
                    <h6>Shepherding Vegetables From Roof to
                      Restaurant</h6>
                  </a> <a href="#" class="post-date">20 Jun 2018</a>
                </div>
              </div>
            ...
            <div class="single-widget-area">
              ...
              <div
                ...
                <div class="product-thumbnail">
                  <a href="/shop-details"><img
                    src="/resources/img/bg-/resources/img/34.jpg" alt=""></a>
                </div>
                <div class="product-info">
